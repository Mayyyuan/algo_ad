...
def task(l_date):
    ...
    for uid in log['UserId']:
        user_uid = user_data[user_data['UserId'] == uid]  # 先取出所有 uid 关联的user_data
        for index in user_uid.index:  # 变量所有的对象
        ...
        all_count += 1
    write_to_result(result, str(log['Date'][0])+'\t' + str(age202_count) + '\t' + str(gender2_count) + '\t'
                    + str(status2_count) + '\t' + str(edu2_count) + '\t' + str(cons2_count) + '\t'
                    + str(device3_count) + '\t' + str(work2_count) + '\t' + str(connect3_count) + '\t'
                    + str(all_count)+'\n')
...
# write header
write_to_result(result, "date" + '\t' + "age202_count" + '\t' + "gender2_count" + '\t' + "status2_count" + '\t'
                + "edu2_count" + '\t' + "cons2_count" + '\t' + "device3_count" + '\t' + "work2_count" + '\t'
                + "connect3_count" + '\t' + "all_count" + '\n')
